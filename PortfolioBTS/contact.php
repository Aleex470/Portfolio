        ...
        <form action="" class="contact__form grid">
            <div class="contact__inputs grid">
                <div class="contact__content">
                    <label for="" class="contact__label">Nom</label><br>
                    <input type="text" class="contact__input">
                </div>

                <div class="contact__content">
                    <label for="" class="contact__label">Adresse mail</label><br>
                    <input type="email" class="contact__input">
                </div>
            </div>

            <div class="contact__content">
                <label for="" class="contact__label">Message</label><br>
                <textarea name="" id="" cols="0" rows="1" class="contact__input-message"></textarea>
            </div>

            <div>
                <a href="#" class="button button--felx">
                    Envoyer message
